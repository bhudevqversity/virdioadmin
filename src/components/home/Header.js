    ...
    const sessionInformation ={
     ...
     // when:this.state.when,
      ...
      const reminder = {
        ...
        cutoff_date_time:this.state.cutoffDateTime,
                ...
                <div className="row">
                  <div className="col-md-4">
                    <div className="form-group">
                      ...
                      <input type="text" className="input-field" id = "session_details" value= {this.state.session_details} onChange = {this.sessionInfo} placeholder="Session Name" onBlur={() => this.validator.showMessageFor('session_details')}/>
