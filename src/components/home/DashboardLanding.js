...
componentDidMount(){
	...
	if(localStorage.getItem('userData')){
		...
		// let ak1 =[{activity: "automatic",
		// 	allowGroupLocation: 0,
		// 	allowParticipantDMOthers: 1,
		// 	channelId: 1110,
		// 	chargeForSession: 0,
		// 	code: 100,
		// 	createdAt: "2019-12-06T13:30:04.000Z",
		// 	currency: "USD",
		// 	cutOffTime: "2019-11-02T09:36:01.000Z",
		// 	description: "ssss",
		// 	displayScript: null,
		// 	duration: 731,
		// 	heartRateMonitor: 0,
		// 	hostEmail: "deepak1@test.com",
		// 	hostFirstName: "Deepak",
		// 	hostId: 1,
		// 	hostImage: null,
		// 	hostLastName: "A",
		// 	hostReminder: 11,
		...
		// 	maxAttendee: 11,
		// 	minAttendee: 3,
		// 	minNotMetNoticeTime: 11,
		// 	name: "ssss",
		// 	onDemand: 0,
		// 	orderWine: 0,
		// 	participantDisableDM: 0,
		// 	participantReminder: 22,
		// 	participantsPickPlaylist: 0,
		// 	rtmChannelId: "2220",
		// 	scheduleDate: "2019-12-12T21:30:00.000Z",
		// 	sessionChargeAllowed: 0,
		// 	sessionId: 8,
		// 	sessionProperty: 0,
		// 	showParticipantsCount: 0,
		// 	showParticipantsPicToOtherPartcipants: 0,
		// 	status: 1,
		// 	type: 3,
		// 	userId: 3,
		// 	video: null,
		...
		// 	minAttendee: 3,
		// 	minNotMetNoticeTime: 11,
		// 	name: "Your Health Matters Coaching",
		// 	onDemand: 0,
		// 	orderWine: 0,
		// 	participantDisableDM: 0,
		// 	participantReminder: 22,
