...
render() {
    ...
    <div className="App">
      ...
      <div className="modal pr-0 fade show" id="manage_group_modal">
            ...
            <div className="modal-content p-3">
                ...
                <div className="modal-body px-0 pb-5 shadow-none round">
                    ...
                    <div className="card border_none bg-gray-shade radius-10">    
                      <div className="card-body position-relative">
                        ...
                        <div className="add_intrst pt-3">
                          <p className="text-uppercase mb-0 pb-0"><a href="#"><span className="mr-2 pr-1">+</span>add interest</a></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="text-center mt-4">
                       <button type="button" className="custom_btn11" id="create_grup">Create A Group</button>
                    </div> 
                </div>
        ...
        <div className="modal pr-0 fade show" id="interest_to_fitness">
          <div className="modal-dialog w-95 first_dialog">
              <div className="modal-content p-3">
                  <div className="modal-header pb-3 border_none">
                    <div><img src="images/login-logo.png" alt="logo" className="logo" /></div>
                    <div><h4 className="modal-title white1 text-center">Add Interest to Fitness</h4></div>
                    <div><button type="button" className="close white closepopup" data-dismiss="modal">×</button></div>
                  </div>
                  <div className="modal-body px-0 pb-5 shadow-none"> 
                                ...
                                <div className="input-field position-relative d-lg-flex flex-wrap d-block px-3">
                                  ...
                                  <div className="one flex-fill mr-4 position-relative">                                  
                                    <div className="custom-file mb-3">
                                      ...
                                      <label className="custom-file-label px-1" for="customFile1">
                                  ...
                                  <div className="one flex-fill position-relative">
                                    <div className="custom-file mb-3">
                                      <input type="file" className="custom-file-input" id="customFile2" name="filename1" />
                                      <label className="custom-file-label px-1" for="customFile2">
      ...
      <div className="modal-inner_part h-100 w-100 d-flex justify-content-center align-items-center">
        <div className="modal-content modl_bg_drk1 small_width">
          <div className="modal-body px-4 pt-5 pb-4"> 
            <div className="form-group mb-2 mt-3"><label className="label">Mobile Number<span className="inp_cover-border"></span></label><input type="text" className="input-field" /></div>
            <div className="text-center mb-3">
              <button type="button" className="custom_btn">save</button>
            </div>   
          </div>
        </div>
      </div>
